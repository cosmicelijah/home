...
# alias sshpi="ssh -X pi@10.0.0.65"
# alias bedrock='~/Minecraft_Bedrock_Launcher-x86_64.0.0.617.AppImage'
alias header="nano ~/.bash_header"
alias grep="grep --color=auto"
alias start="source ~/.bashrc"
# alias etcher="~/Downloads/balenaEtcher-1.5.113-x64.AppImage"
...
alias mail="~/Downloads/zoho-mail-desktop-x64-v1.3.1.AppImage"
